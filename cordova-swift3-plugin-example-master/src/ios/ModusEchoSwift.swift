...
@objc(ModusEchoSwift)
class ModusEchoSwift : CDVPlugin, NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func prepScanner(command: CDVInvokedUrlCommand) -> Bool{
        ...
        do {
            if (captureSession?.isRunning != true){
                ...
                //JENIS
                deviceOutput.setSampleBufferDelegate(self, queue: DispatchQueue(label: "sample buffer"))
                //JENIS
