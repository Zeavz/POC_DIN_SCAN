...
public class CameraScreenFrag extends Fragment{
   ...
   public interface OnFragBackClick{
        void onBackPressed();
        void dinRecieved(String din);
    }
    ...
    public void setListener(OnFragBackClick varListener){
        mBackCall = varListener;
    }
                    ...
                    public void onResponse(String response) {
                        if (response != null) {
                            try{
                                ...
                                mBackCall.dinRecieved(toOutputNum);
    ...
    private void setUpCameraScreen(){
        ...
        backButton = (Button) viewer.findViewById(getResources().getIdentifier("btnBack", "id", appResourcesPackage));
        ...
        backButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                final android.widget.Toast toast = android.widget.Toast.makeText(
                  ...
                  "I should take you back now",
                  android.widget.Toast.LENGTH_LONG 
                    );
                    toast.show();
                }
                });
                mBackCall.onBackPressed();
            }
        });
